<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NotD.aspx.cs" Inherits="NotD" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page bg-gradient-3">




            <!-- Page Header-->
            <section class="section fullwidth-page">
                <div class="fullwidth-page-inner">
                    <div class="section-md text-center">
                        <div class="shell">
                            <p class="breadcrumbs-custom-subtitle">دسترسی شما به این صفحه امکان پذیر نمی باشد</p>
                            <p class="heading-1">شما به این صفحه دسترسی ندارید</p>
                            <a class="button button-secondary" href="/index.aspx">رفتن به خانه</a>
                        </div>
                    </div>
                    <!-- Page Footer-->
