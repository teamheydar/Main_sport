<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Panel.master" AutoEventWireup="true" CodeFile="ViewAdmin.aspx.cs" Inherits="Admin_View_ViewAdmin" %>
                ...
                <div class="card invoice-preview-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-12 col-sm-7 col-12">
                                <table class="lh-2">
                                    <tbody>
                                        <tr>
                                            <td class="pe-3">نام باشگاه:</td>
                                            <td id="tNameGym" runat="server"></td>
                                        </tr>
                                        <tr>
                                            <td class="pe-3">شماره تلفن باشگاه:</td>
                                            <td id="tNPhoneGym" runat="server"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 lh-1-85">
                                <span class="fw-semibold">آدرس مدیریت:</span>
