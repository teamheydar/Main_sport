<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Panel.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ViewUser.aspx.cs" Inherits="Admin_View_ViewUser" %>
        ...
        <div class="row invoice-preview">
            ...
            <div class="col-xl-9 col-md-8 col-12 mb-md-0 mb-4">
                <div class="card invoice-preview-card">
                    <div class="card-body">
                        <div style="text-align: center" class="alert alert-danger" role="alert" id="message" runat="server">نام کاربری انتخاب شده تکراری است</div>
                    ...
                    <div class="col-12">
                        <div class="col-xl">
                            <div class=" mb-4">
                                ...
                                <% 
                                    //Get Sans Buy
                                    var SansBuy = Data.tbl_SansBuys.Where(s =>
                                        s.UserID == DataUser.ID &&
                                        s.Deleted == 0);
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions">
                <div class="card">
                    <div class="card-body">
                        <% if (DataUser.OkAdmin == 0)
                            {%>



                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-info d-grid w-100 mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            تاید کاربر
                        </button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header ">
                                        <h5 class="modal-title" id="exampleModalLabel">ثبت کد کاربر</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="code" runat="server" required="required" />
                                        </div>
                                    </div>
                        ...
                        <% } %>
                        <a href="../RegisterUser.aspx" class="btn btn-primary d-grid w-100 mb-3">افزودن کاربران
                        </a>

                        <asp:Button ID="Cancel" OnClick="Cancel_OnClick" runat="server" CssClass="btn btn-danger d-grid w-100 mb-3" Text="بازگشت به گزارشات کاربران" />
                    </div>
                </div>
            </div>
            <!-- /Invoice Actions -->
