...
<!DOCTYPE html>
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="horizontal-menu-template">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="app-brand justify-content-center">
                                <a href="index.aspx" class="app-brand-link gap-2">
                                    ...
                                    <span class="app-brand-text demo h3 mb-0 fw-bold">ثبت نام</span>
                                </a>
                            </div>
                            <!-- /Logo -->
                            <%--<h4 class="mb-2">ماجراجویی اینجا شروع می‌شود</h4>--%>
                            <p class="mb-4">برای ورود به سایت وارد شوید یا ثبت نام کنید!</p>

                            <div class="alert alert-danger" role="alert" id="message" runat="server"></div>

                            <div class="mb-3">
                                <label for="txtFulName" class="form-label">نام و نام خانوادگی:</label>
                                <input type="text" required="required" class="form-control text-start" dir="ltr" runat="server" id="txtFulName" placeholder="نام کامل خود را وارد کنید" autofocus />
                            </div>
                            <div class="mb-3">
                                <label for="txtCodey" class="form-label">کد ملی:</label>
                                <input type="text" required="required" class="form-control text-start" dir="ltr" runat="server" id="txtCodey" placeholder="کدملی خود را وارد کنید" />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="txtNumberPhone">شماره تلفن:</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" required="required" runat="server" id="txtNumberPhone" class="form-control text-start" dir="ltr" placeholder="شماره تلفن همراه خود را وارد کنید" aria-describedby="password" />
                                    <%--<span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>--%>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="selectGym" class="form-label">باشگاه:</label>
                                <select class="form-select" id="selectGym" runat="server" aria-label="Default select example">
                                </select>
                            </div>

                            <asp:Button CssClass="btn btn-primary d-grid w-100 mb-2" ID="btnRegister" OnClick="btnRegister_OnClick" runat="server" Text="عضویت" />
                            
                            <div class="d-flex justify-content-center">
                                
                                <a href="/index.aspx" class="btn btn-label-google-plus col-12 mb-3">
                                    رفتن به صفحه اصلی
                                </a>
