<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NotEGymMy.aspx.cs" Inherits="NotEGymMy" %>
            ...
            <section class="section fullwidth-page bg-gradient-3">
                <div class="fullwidth-page-inner">
                    <div class="section-md text-center">
                        <div class="shell">
                            <p class="breadcrumbs-custom-subtitle">تاریخ اعتبار باشگاه شما به پایان رسیده است</p>
                            <p class="heading-1">اتمام تاریخ اعتبار باشگاه شما</p>
