<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NotActive.aspx.cs" Inherits="NotActive" %>
            ...
            <section class="section fullwidth-page bg-gradient-3">
                <div class="fullwidth-page-inner">
                    <div class="section-md text-center">
                        <div class="shell">
                            <p class="breadcrumbs-custom-subtitle">باشگاه شما توسط ادمین اصلی سایت غیر فعال شده است.</p>
                            <p class="heading-1">باشگاه شما غیر فعال است</p>
